...
## 4 ตอบ เมื่อเพิ่มคำสั่งนี้ อาจพบว่า ข้อความ End main แสดงก่อนที่การชงกาแฟจะเสร็จ เพราะ
main thread ทำงานเสร็จเร็วกว่า ในขณะที่ Thread อื่นยังทำงานอยู่

## 5 ตอบ การใช้synchronized จะช่วยให้ Thread เข้าใช้งานเครื่องชงกาแฟได้ทีละตัว ป้องกันปัญหา
Race Condition ส่วน AtomicInteger ใช้ส าหรับจัดการตัวนับ เช่น หมายเลขออเดอร์ ให้
ปลอดภัยเมื่อหลาย Thread ใช้งานพร้อมกัน
